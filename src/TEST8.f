...
C     IONS HAVE ONLY ONE CHARGE 
      NC(1) = 1
      NC(2) = 1
C     THE MASS OF THE HYDROGEN AND HEAVY IMPURITY
      M(1) = 1.6727E-27
      M(2) = 16000000*1.6727E-27
C     THE CHARGE OF THE HYDROGEN AND HEAVY IMPURITY
      ZSP(1,1) = 1
      ZSP(2,1) = 4
