      ...
      subroutine psflux(t,nsm,ncm,mas,den,zsp,tau,
     +                  l1,l2,l3,l11tt,l11th,l12th)
C     SUBROUTINE THAT CALCULATES THE TRANSPORT COEFFICIENTS 
C     FOR THE PARTICLE FLUX OF A TRACE IMPURITY IN AN HYDROGEN
C     PLASMA WITH AN IMPURITY. (PFIRSCH SCHLUETER REGIME)
     ...
     +          tau(nsm,nsm),zsp(nsm,ncm),den(nsm,ncm)
